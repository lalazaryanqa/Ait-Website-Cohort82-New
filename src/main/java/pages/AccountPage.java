...
public class AccountPage extends HelperBase {
    ...
    public AccountPage clickEditProfile() {
        click(By.cssSelector(
                "[data-hook='Profile-EditProfileButton']"
        ));
        pause(3000);
        return this;
    }
    ...
    public AccountPage fillFirstName(String firstName) {
        type(By.cssSelector("input[data-hook='MyAccount-textField']" +
                                "[name='fields.2.value']"), firstName);
        pause(3000);
        return this;
    }
    ...
    public AccountPage uploadProfileImage(String imagePath) {
        wd.findElement(
                By.cssSelector("input[type='file'][name='member.profile.photo']"
               )).sendKeys(imagePath);
        pause(3000);
        return this;
    }
